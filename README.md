...
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-15.3-396a94?style=for-the-badge&logo=postgresql&logoColor=blue)](https://www.postgresql.org/docs/release/15.3/)
...
1. Инициализировать БД для тестов: `make test-init`
2. Запустить тесты: `make test-run`
